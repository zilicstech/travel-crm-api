...
/**
 * One debit or credit row on a vendor's subsidiary payables ledger. Append-only - see
 * {@code service.SupplierLedgerService}, the sole writer. The unique index on
 * {@code (source_type, source_id, entry_type)} is the idempotency guarantee, mirroring
 * {@link CustomerLedgerEntry}. Sign convention: CREDIT raises payable, DEBIT lowers it - see
 * ARCHITECTURE-SPINE AD-4.
 */
@Entity
